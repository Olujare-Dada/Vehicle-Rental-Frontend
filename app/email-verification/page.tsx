...
import { Car, CheckCircle, XCircle, ArrowRight, Mail, Phone, MapPin } from "lucide-react"
...
export default function EmailVerificationPage({
  ...
  const errorMessage = searchParams.message || "An error occurred during email verification."
              ...
              {isPending ? (
                ...
                <Card className="border-blue-200 bg-blue-50/50">
                  <CardHeader>
                    ...
                    <CardTitle className="text-3xl text-blue-800">Check Your Email!</CardTitle>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="pt-4 border-t border-blue-200">
                      <p className="text-sm text-blue-600">
                        ...
                        <Link href="/signup" className="font-medium text-blue-700 hover:text-blue-800 underline">
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-red-600">
                        This could be due to an expired verification link or an invalid token. Please check your email for a fresh verification link.
                      </p>
                    </div>
